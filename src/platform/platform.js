            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-6 ml-auto">
                        <p className="ml-auto" style={{textAlign:"right",fontWeight:"bold",fontSize:"48px",lineHeight:"58px",paddingTop:"100px",color:"white",fontFamily:"Russo One"}}>Learn Everything from
                        One Platform.</p>
