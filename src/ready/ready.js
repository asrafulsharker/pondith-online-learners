            ...
            <div style={{margin:"100px",backgroundColor:"#151515",borderRadius:"81px",boxShadow:"0px 4px 4px rgba(0, 0, 0, 0.25)"}}>
                <div className="container" style={{padding:"0px"}}>
                    <div className="row">
                       ...
                       <p className="" style={{textAlign:"cent er"}}><a  href="#" style={{color:"white",marginLeft: "80px",textDecoration:"none",background:"#FF290C",textAlign:"center",padding:"18px 30px",fontWeight:"bold",fontSize:"24px",lineHeight:"28px",borderRadius:"20px"}}>Register Now</a></p>
                       </div>
